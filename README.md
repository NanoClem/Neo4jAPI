...
**Since this project is fully based on a single data model, a more generic version is available [here](https://github.com/NanoClem/Flask4J-api) if you want to deal with any dataset.**
